...
public class CustomJsonValidation {
    ...
    /** The Constant logger. */
    private final static Logger logger = LoggerFactory.getLogger(CustomJsonValidation.class);
    ...
    public static boolean validate(String schemaFile, String json) {
        ...
        boolean result = true;
        try {
            JsonSchema jsonSchema = CustomJsonValidation.getSchemaNodeFromPath(schemaFile);
            JsonNode jsonNode = CustomJsonValidation.getJsonNode(json);
